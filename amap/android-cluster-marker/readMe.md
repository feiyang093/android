本工程为基于高德地图Android SDK进行封装 参照了官方的例子 [实现了Marker聚合效果的例子](https://github.com/amap-demo/android-cluster-marker).
之前看到官方文档的时候，没有说明，特此作为说明
## 原理说明 ##
- 按照一定的规则，进行分组，每一个组只能显示一个点
- 每一次 刷新界面的时候，或者移动界面的时候，都重新分组
- 分组规则 默认第一个点为中心，按照一定的范围数，符合条件的，作为一组
